...
export default function ProductDetailModal({ productId, routeStoreId, isOpen, onClose }: { productId: string | null; routeStoreId: string | null; isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans transition-colors duration-300 pb-24 lg:pb-8">
      ...
      {isCheckoutOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center sm:p-4 bg-white dark:bg-slate-900 sm:bg-slate-900/75 sm:dark:bg-black/85 backdrop-blur-md animate-in fade-in slide-in-from-bottom sm:slide-in-from-bottom-0 duration-300">
          <div className="bg-white dark:bg-slate-900 sm:border border-slate-200 dark:border-slate-800 sm:rounded-[2.5rem] w-full h-full sm:h-auto sm:max-h-[90vh] max-w-lg flex flex-col shadow-none sm:shadow-2xl overflow-hidden">
            
            {/* Modal Header */}
            <div className="px-4 sm:px-8 py-4 sm:py-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between shrink-0">
              <div>
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-6 text-slate-800 dark:text-slate-200 text-left">
            ...
            <div className="px-4 sm:px-8 py-4 sm:py-6 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 flex flex-col gap-3 shrink-0">
              ...
              <button
                ...
                className="w-full py-3.5 bg-emerald-500 hover:bg-emerald-450 text-slate-950 font-black rounded-xl text-xs uppercase tracking-widest active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/10"
              >
                {isProcessing ? (
                  <>
