        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200">
          <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-6 max-w-md w-full space-y-6 shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center pb-2 border-b border-slate-800">
              ...
              <button onClick={() => setIsPickupModalOpen(false)} className="text-slate-450 hover:text-white transition-colors">
                ✕
              </button>
            </div>
            ...
            <form onSubmit={handleConfirmPickup} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-xs text-white placeholder-slate-650 focus:outline-none focus:border-accent transition-colors resize-none"
                />
              </div>
