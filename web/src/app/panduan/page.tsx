...
const CHAPTERS = [
  
  {
    ...
    content: (
      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-white/10 pb-2">BAB 1: Pendahuluan & Persiapan Awal</h2>
...
<hr className="my-8 border-white/10" />
    ...
    ,
  {
    ...
    content: (
      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-white/10 pb-2">BAB 2: Manajemen Data Induk (Master Data)</h2>
...
<hr className="my-8 border-white/10" />
    ...
    ,
  {
    ...
    content: (
      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-white/10 pb-2">BAB 3: Operasional Kasir (Point of Sale / POS)</h2>
...
<hr className="my-8 border-white/10" />
    ...
    ,
  {
    ...
    content: (
      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-white/10 pb-2">BAB 4: Manajemen Transaksi Khusus</h2>
...
<hr className="my-8 border-white/10" />
    ...
    ,
  {
    ...
    content: (
      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-white/10 pb-2">BAB 5: Penjualan Online (Marketplace & Orders)</h2>
...
<hr className="my-8 border-white/10" />
    ...
    ,
  {
    ...
    content: (
      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-white/10 pb-2">BAB 6: Pelaporan & Riwayat</h2>
...
<hr className="my-8 border-white/10" />
    ...
    ,
  {
    ...
    content: (
      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-white/10 pb-2">BAB 7: Pengaturan Lanjutan</h2>
...
<hr className="my-8 border-white/10" />
    ...
    ,
  {
    ...
    content: (
      <div className="mb-10">
        <h2 className="text-xl font-bold mb-4 text-white border-b border-white/10 pb-2">BAB 8: Fitur Super Admin (Khusus Pengelola Aplikasi/Sistem)</h2>
    ...
    <div className="min-h-screen bg-slate-950 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-8">
        ...
        <div className="mb-6 relative">
          ...
          <input
            type="text"
            className="w-full bg-slate-900 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
...
<hr className="my-8 border-white/10" />
          ...
          {filteredChapters.length > 0 ? (
            ...
            <div className="py-12 text-center flex flex-col items-center opacity-50">
              ...
              <p className="text-slate-300 font-medium">Tidak ada hasil panduan yang cocok dengan pencarian Anda.</p>
            </div>
          )}
        </div>
      </div>
