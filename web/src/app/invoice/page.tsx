...
import { Loader2, Printer, MapPin, Phone, Globe, CreditCard, History, ShieldAlert } from 'lucide-react';
...
function InvoiceA4Content() {
        ...
        if (trxSnap.exists()) {
          ...
          if (storeId) {
            ...
            try {
              ...
              console.warn("Failed to fetch products for dynamic warranty in invoice page:", err);
            }
          }
        }
      } catch (err) {
  ...
  }, [loading, trx, isLogoReady, settings?.storeName, isEstimation, isLocked]);
