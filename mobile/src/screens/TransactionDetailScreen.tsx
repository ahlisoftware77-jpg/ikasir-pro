...
import { collection, query, onSnapshot, orderBy, limit, doc, deleteDoc, where, updateDoc, getDoc, writeBatch } from 'firebase/firestore';
    ...
    <SafeAreaView className="flex-1" edges={['bottom', 'top']} style={{ backgroundColor: colors.bg }}>
            ...
            <View className="flex-row items-center justify-between p-6 border-b" style={{ borderColor: colors.border }}>
              ...
              <View className="flex-row items-center gap-2">
                {selectedTrx?.id && (
                  <TouchableOpacity onPress={() => handleDeleteTrx(selectedTrx.id!)} className="p-2.5 bg-rose-500/10 rounded-full border border-rose-500/20">
      ...
      {/* Modal Struk Digital */}
      <Modal visible={viewingReceipt !== null} animationType="fade" transparent onRequestClose={() => setViewingReceipt(null)}>
        <View className="flex-1 bg-black/70 justify-center items-center">
          ...
          >
            ...
            {/* Button Aksi */}
            <View className="p-6 flex-row gap-2 border-t" style={{ backgroundColor: colors.surface, borderColor: colors.border }}>
              <TouchableOpacity 
                onPress={() => setViewingReceipt(null)}
