          ...
          <div style="display: flex; flex-direction: column; gap: 15px; flex: 1.3;">
            ...
            <div>
              <div class="qr-section">
                ...
                <img src="${qrUrl}" style="width: 80px; height: 80px; border: 1px solid #e2e8f0; padding: 2px; background: #fff;" />
...
export const printServiceA4 = async (ticket: any, storeSettings?: any) => {
  ...
  if (ticket?.storeId) {
    try {
      ...
      console.warn("Failed to fetch settings from Firestore in printServiceA4:", err);
    }
  }
  ...
  try {
    ...
    console.error('Error printing service A4:', error);
    throw error;
  }
};
